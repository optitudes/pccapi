<head>
	...
	<!-- Page Title -->
	<title>PCC - Paisaje Cultural Cafetero</title>
...
<nav class="panel top">
  <div class="sections desktop">
    <div class="left"><a href="#" title="Paisaje Cultural Cafetero"><svg style="width:82px;height:24px"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#logo"></use></svg></a></div>
    <div class="center">
      <ul class="menu">
        <li><a href="#">Home</a></li>
        <!--<li><a href="#videos">Videos</a></li>-->
        <li><a href="#features">Caracteristicas</a></li>
        <!--<li><a href="#case">Casos de estudio</a></li>-->
        ...
        <div class="fix-12-12">
          <ul class="flex fixedSpaces verticalCenter reverse">
            <li class="col-6-12 left middle">
              <h1 class="ae-1 fromLeft">Paisaje Cultural Cafetero.</h1>
              <p class="ae-2 fromLeft"><span class="opacity-8"> Aplicación móvil para la publicación de los resultados del grupo de investigación BIOEDUQ de la Universidad del Quindío..</span></p>
              <a class="button blue gradient ae-3 fromCenter cropLeft">Empezar</a><a class="button white ae-4 fromCenter">Aprende mas</a>
            </li>
            <li class="col-6-12">
        ...
        <div class="fix-12-12">
          <ul class="grid">
            <li class="col-6-12 left">
              <h1 class="ae-2 fromLeft">Videos de muestra PCC</h1>
              <p class="ae-3 fromLeft"><span class="opacity-8">Podemos ver una muestra de los videos de los proyectos realizados en el grupo de investigación XXX.</span></p>
              <ul class="tabs controller uppercase bold ae-4 fromCenter" data-slider-id="60-1">
                <li class="selected">Proyecto 1</li>
                <li>Proyecto 2</li>
                <li>Proyeto 3</li>
              </ul>
            </li>
    ...
    <div class="container">
      <div class="wrap">
        <div class="fix-10-12">
          ...
          <iframe width="560" height="315" src="https://www.youtube.com/embed/C6PPKTASboY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
  ...
  <div class="content">
    <div class="container">
      <div class="wrap">
        <div class="fix-10-12">
          <div class="embedVideo popupContent">
          <iframe width="560" height="315" src="https://www.youtube.com/embed/RKXP4QNdl6I" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="content">
    <div class="container">
      <div class="wrap">
        <div class="fix-10-12">
          <div class="embedVideo popupContent">
          <iframe width="560" height="315" src="https://www.youtube.com/embed/WRnysvMnExk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="fix-12-12">
          <ul class="flex verticalCenter">
            ...
            <li class="col-7-12 left">
              <h1 class="ae-2 fromRight">Inspirador</h1>
              <div class="ae-3 fromRight">
                <p class="opacity-8">Este proyecto dará a conocer los resultados obtenidos en las investigaciones realizadas en el paisaje cultural cafetero, dando una descripción de cada uno de los proyectos, imágenes y podcasts.</p>
              </div>
              <div class="relative">
              <img src="assets/img/icon-2.png" class="ae-3 fromCenter app-26" alt="app"/>
                <div class="text-26">
                  <h3 class="ae-3 fromRight">APP</h3>
                  <div class="ae-5 fromRight">
                    <p class="tiny opacity-6">Por definir</p>
                  </div>
                </div>
              </div>
            </li>
    ...
    <div class="container">
      <div class="wrap">
        ...
        <div class="fix-12-12 toCenter">
          <div class="fix-7-12">
            <p class="margin-bottom-2 ae-1"><span class="opacity-6">Casos de estudio</p>
            <h1 class="ae-2 huge fromAbove margin-bottom-2">Estos son algunos casos de estudio</h1>
            <a href="#" class="button green gradient ae-3">Inicio</a>
          </div>
          <ul class="grid fixedSpaces left margin-top-10">
            <li class="col-3-12 col-tablet-1-2 col-phablet-1-1 ae-4 fromLeft">
             <h3>Proyecto 1</h3>
             <p class="tiny opacity-6">Resumen proyecto 1</p>
            </li>
            <li class="col-3-12 col-tablet-1-2 col-phablet-1-1 ae-5 fromLeft">
             <h3>Proyecto 2</h3>
             <p class="tiny opacity-6">Resume proyecto 2</p>
            </li>
            <li class="col-3-12 col-tablet-1-2 col-phablet-1-1 ae-6 fromLeft">
             <h3>Proyecto 3</h3>
             <p class="tiny opacity-6">Resumen proyecto 3</p>
            </li>
            <li class="col-3-12 col-tablet-1-2 col-phablet-1-1 ae-7 fromLeft">
             <h3>Proyecto 4</h3>
             <p class="tiny opacity-6">Resumen protecto 4.</p>
            </li>
          </ul>
        </div>
    ...
    <div class="container">
      <div class="wrap">
        ...
        <div class="fix-6-12">
          ...
          <p class="hero ae-2 margin-bottom-3"><span class="opacity-8">Explora y aprende</span></p>
          ...
          <form action="#" autocomplete="off" class="slides-form margin-bottom-3">
            ...
            <button type="submit" class="button blue gradient ae-4" name="submit">Pruebalo libremente</button>
          </form>
...
<nav class="panel bottom forceMobileView">
  <div class="sections desktop">
    <div class="left"><a href="#" class="opacity-8">Universidad del <a href="https://www.uniquindio.edu.co" target="_blank">Quindio</a></div>
